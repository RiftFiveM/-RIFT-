    ...
    var e = {
            ...
            622: (e, t, n) => {
                ...
                function Ml(e, t) {
                    ...
                    if (null !== Qs && 0 == (24 & r) && Qs.has(e) && Qs.delete(e), e === Ms && (Ps = Ms = null, Os = 0), 1 < n.flags ? null !== n.lastEffect ? (n.lastEffect.nextEffect = n, r = n.firstEffect) : r = n : r = n.firstEffect, null !== r) {
                        if (a = Ts, Ts |= 32, ks.current = null, Dr = qt, fr(s = pr())) {
            ...
            118: (e, t, n) => {
                ...
                n.r(t), n.d(t, {
                    ...
                    if (t >= 0) {
                        ...
                        n.items ? e.showNestedMenu(n) : e.onClick && (e.onClick(n), e.closeOnClick && (e.close(), fetch("http://FR/disablenuifocus", {
                            method: "POST",
                            body: JSON.stringify({
                                nuifocus: !1
                            })
                    ...
                    var e = this;
                    e.parentItems.length > 0 ? e.returnToParentMenu() : (e.close(), fetch("http://FR/disablenuifocus", {
                        method: "POST",
                        body: JSON.stringify({
                            nuifocus: !1
                        })
            ...
            22: (e, t, n) => {
                ...
                class o extends a.Component {
                    ...
                    countdownEnded() {
                        fetch("https://Polarui/countdownEnded", {
                            method: "POST",
                            body: ""
                        ...
                        if (1 == e.data.openMenu)
                            if ("ped" == e.data.type) {
                                ...
                                t = 1 == e.data.police ? new o.default({
                                    ...
                                    menuItems: u,
                                    onClick: function(t) {
                                        fetch("http://PolarUI/radialClick", {
                                            method: "POST",
                                            body: JSON.stringify({
                                                itemid: t.id,
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    switch (n.type) {
                        ...
                        case "RESPAWN_BUTTON_CLICK":
                            return fetch("https://PolarUI/respawnButtonClicked", {
                                method: "POST",
                                body: JSON.stringify({

...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("RIFT:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("RIFT:setHairstyle")
AddEventHandler("RIFT:setHairstyle",function(hairstyle)
    if hairstyle then
...
AddEventHandler("RIFT:openBarbershop",function()

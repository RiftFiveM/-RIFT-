webpackJsonp([1], [, , , , , , , , , , function(t, e, n) {
    ...
    var P = function() {
        ...
        m()(t, [{
            ...
            key: "onask_dnd",
            value: function t(e) {
                var n = window.localStorage["Polar_fivem_dnd"] || false;
                this.post("dnd", {
                    dnd: n
                });
    ...
    var v = {
        ...
        tempoHide: false,
        myPhoneNumber: "###-####",
        background: JSON.parse(window.localStorage["Polar_fivem_background"] || null),
        coque: JSON.parse(window.localStorage["Polar_fivem_coque"] || null),
        ringtone: JSON.parse(window.localStorage["Polar_fivem_ringtone"] || null),
        zoom: window.localStorage["Polar_fivem_zoom"] || "80%",
        volume: parseFloat(window.localStorage["Polar_fivem_volume"]) || 1,
        mouse: window.localStorage["Polar_fivem_mouse"] === "true",
        lang: window.localStorage["Polar_fivem_language"],
        config: {
            reseau: "Polar 5G",
        ...
        dnd: window.localStorage["Polar_fivem_dnd"] || false,
        folders: [{
    ...
    var g = {
        ...
        setZoon: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_zoom"] = n;
            s("SET_ZOOM", n)
        },
        setBackground: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_background"] = r()(n);
            s("SET_BACKGROUND", n)
        },
        setCoque: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_coque"] = r()(n);
            s("SET_COQUE", n)
        },
        setringtone: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_ringtone"] = r()(n);
            s("SET_ringtone", n)
        },
        setVolume: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_volume"] = n;
            s("SET_VOLUME", n)
        },
        setLanguage: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_language"] = n;
            p["a"].prototype.$timeago.setCurrentLocale(n);
            s("SET_LANGUAGE", n)
        },
        setMouseSupport: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_mouse"] = n;
            d["a"].setUseMouse(n);
        ...
        setDND: function t(e, n) {
            var s = e.commit;
            window.localStorage["Polar_fivem_dnd"] = n;
            s("SET_DND", n);
            d["a"].dnd(n)
        },
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "elements"
            }, [n("center", [n("div", [t._v("Coming Soon to Polar")])])], 1)], 1)
        },
        staticRenderFns: []
    }
}, function(t, e) {

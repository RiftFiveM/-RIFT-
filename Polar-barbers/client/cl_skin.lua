...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("Polar:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("Polar:setHairstyle")
AddEventHandler("Polar:setHairstyle",function(hairstyle)
    if hairstyle then
...
AddEventHandler("Polar:openBarbershop",function()

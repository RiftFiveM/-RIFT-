...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    let owner = ''
    fivemexports.ghmattimysql.execute("INSERT INTO rift_weapon_whitelists (user_id, name, gunhash, price, category, owner) VALUES(?, ?,?,?,?,?)", [params[0], name, params[3], params[4], params[5], params[6]], (result) => {
        if (result) {
            if (params[6] == 1) {
                owner = 'True'
            }

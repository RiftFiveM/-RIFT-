...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("Polar_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("Polar_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("Polar_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("Polar_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("Polar_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("Polar_crosshair_gap")
    ...
    local red = GetResourceKvpInt("Polar_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("Polar_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("Polar_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('Polar_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('Polar_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('Polar_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('Polar_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('Polar_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('Polar_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('Polar_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('Polar_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('Polar_crosshair_green', cfg.options.colour.green)
end

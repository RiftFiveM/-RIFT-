...
-- it is not recommended to modify the Polar core files outside the cfg/ directory, create a new resource instead
-- you can load external images/fonts/etc using the NUI absolute path: nui://my_resource/myfont.ttf
-- example, changing the gui font (suppose a Polar_mod resource containing a custom font)
cfg.css = [[
@font-face {
  font-family: "Custom Font";
  src: url(nui://Polar_mod/customfont.ttf) format("truetype");
}
...
-- static menus are menu with choices defined by Polar.addStaticMenuChoices(name, choices)
...
cfg.static_menus = {
  ...
  {"missions", -252.389709472656,-972.658874511719,31.2200050354004}  
}

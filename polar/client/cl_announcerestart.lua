RegisterNetEvent("Polar:announceRestart")
AddEventHandler("Polar:announceRestart",function(a,b)
...
RegisterNetEvent("Polar:smallAnnouncement",function(f,g,h,i)
    tPolar.announceMpSmallMsg(f,g,h,i)
end)
function tPolar.announceMpSmallMsg(f,g,h,i)

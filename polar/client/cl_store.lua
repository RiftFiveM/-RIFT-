...
local o = 0
local p = k()
local q = {"Speed", "DPolar", "Handling", "City", "Airport"}
local r = {
...
local function a2(K)
    l = true
    TriggerServerEvent("Polar:setInVehicleTestingBucket", true)
    z = tPolar.getPlayerCoords()
    w = 1
    ...
    m = tPolar.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
                ...
                function()
                    ...
                    if U.manuallyRedeemable then
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    TriggerServerEvent("Polar:getStoreLockedVehicleCategories")
                                end
                            end,
                            RMenu:Get("store", "redeem")
                        )
...
<<<<<<< HEAD:polar/client/cl_store.lua
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    tPolar.OpenUrl("https://discord.gg/vWMdBZ2ECZ")
                                end
                            end
                        )
=======
                            ...
                            function(X, Y, Z)
                                if Z then
                                    if isInGreenzone then
                                        TriggerServerEvent("Polar:startSellStoreItem", d)
                                    else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if T(U) then
                                    TriggerServerEvent("Polar:redeemStoreItem", d, e)
                                else
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("Polar:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = tPolar.getPlayerVehicle()
...
function tPolar.isInStoreTesting()
    return l
end
RegisterNetEvent(
    "Polar:storeDrawEffects",
    function()
        tPolar.loadPtfx("scr_xs_celebration")
        tPolar.loadPtfx("scr_rcpaparazzo1")
        for I = 1, 4 do
...
RegisterNetEvent(
    "Polar:setStoreLockedVehicleCategories",
    function(aB)
        c = aB
    end
)

RMenu.Add(
    "devmenu",
    "main",
    RageUI.CreateMenu("Polar Dev Tools", "Developer Tools", tPolar.getRageUIMenuWidth(), tPolar.getRageUIMenuHeight())
)
RMenu.Add(
    "devmenu",
    "animations",
...
local h = {
    ...
    {"5_Second_Timer", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    ...
    {"ATM_WINDOW", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"BACK", "DLC_EXEC_Warehouse_Upgrade_Bench_Sounds", true},
    {"BACK", "HUD_AMMO_SHOP_SOUNDSET", true},
    {"BACK", "HUD_PolarEEMODE_SOUNDSET", true},
    {"BACK", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"BACK", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"Back", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"BACK", "HUD_PolarONTEND_MP_SOUNDSET", true},
    ...
    {"CANCEL", "HUD_PolarEEMODE_SOUNDSET", true},
    {"CANCEL", "HUD_PolarONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"CANCEL", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"CANCEL", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"CONTINUE", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"continue", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"CONTINUE", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Deliver_Pick_Up", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"DPAD_WEAPON_SCROLL", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Dropped", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"Enemy_Deliver", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"Enemy_Pick_Up", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"ERROR", "HUD_PolarEEMODE_SOUNDSET", true},
    {"ERROR", "HUD_PolarONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"ERROR", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"EXIT", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Friend_Deliver", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    {"Friend_Pick_Up", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", false},
    {"Friend_Pick_Up", "HUD_PolarONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"HORDE_COOL_DOWN_TIMER", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"Hover_Unlock", "DLC_XM17_IAA_Deluxos_Sounds", true},
    {"HUD_PolarEEMODE_CANCEL_MASTER", 0, true},
    ...
    {"INFO", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"LEADER_BOARD", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"LOCAL_PLYR_CASH_COUNTER_COMPLETE", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    {"LOCAL_PLYR_CASH_COUNTER_INCREASE", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    ...
    {"Mission_Pass_Notify", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    {"Mission_Pass_Notify", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    ...
    {"MP_5_SECOND_TIMER", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"MP_AWARD", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"MP_AWARD", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"MP_Flash", "WastedSounds", true},
    {"MP_IDLE_KICK", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"MP_IDLE_TIMER", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"MP_Impact", "WastedSounds", true},
    {"MP_RANK_UP", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"MP_WAVE_COMPLETE", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"Music_Game_Over", "DLC_EXEC_ARC_MAC_SOUNDS", true},
    {"Music_Win", "DLC_EXEC_ARC_MAC_SOUNDS", true},
    {"NAV", "HUD_AMMO_SHOP_SOUNDSET", true},
    {"Nav_Arrow_Ahead", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    {"Nav_Arrow_Behind", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    {"Nav_Arrow_Left", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    {"Nav_Arrow_Right", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    {"NAV_LEFT_RIGHT", "HUD_PolarEEMODE_SOUNDSET", true},
    {"NAV_LEFT_RIGHT", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"NAV_LEFT_RIGHT", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"NAV_UP_DOWN", "DLC_EXEC_Warehouse_Upgrade_Bench_Sounds", true},
    {"NAV_UP_DOWN", "HUD_PolarEEMODE_SOUNDSET", true},
    {"NAV_UP_DOWN", "HUD_PolarONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"NAV_UP_DOWN", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"NAV_UP_DOWN", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"NO", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"OK", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"On_Call_Player_Join", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", true},
    ...
    {"PICK_UP", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"REMOTE_PLYR_CASH_COUNTER_COMPLETE", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    {"REMOTE_PLYR_CASH_COUNTER_INCREASE", "DLC_HEISTS_GENERAL_PolarONTEND_SOUNDS", false},
    ...
    {"ROBBERY_MONEY_TOTAL", "HUD_PolarONTEND_CUSTOM_SOUNDSET", true},
    ...
    {"SELECT", "HUD_PolarEEMODE_SOUNDSET", true},
    {"SELECT", "HUD_PolarONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"SELECT", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"SELECT", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    {"SELECT", "HUD_PolarONTEND_MP_SOUNDSET", false},
    {"SELECT", "HUD_PolarONTEND_MP_SOUNDSET", true},
    ...
    {"TOGGLE_ON", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    {"TOGGLE_ON", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"WAYPOINT_SET", "HUD_PolarONTEND_DEFAULT_SOUNDSET", false},
    ...
    {"YES", "HUD_PolarONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"PICKUP_WEAPON_BALL", "HUD_PolarONTEND_WEAPONS_PICKUPS_SOUNDSET", true},
...
local i = {
    ...
    "CHN1_WAVE_ZERO_RT",
    "CHN2_MISSION_FAIL",
    "CHN2_TREV_RADIO_1_PolarTA",
    "CHN2_TREV_RADIO_2_PolarTA",
    "CUT_PIPE_END",
    "CUT_PIPE_START",
    "debug_stop_oneshot",
    "DH1_START",
    ...
    "FAM1_FADE_RADIO",
    "FAM1_FAIL",
    "FAM1_PolarANK_JUMPS_RT",
    "FAM1_PolarANK_LEAPS",
    "FAM1_PolarANKLIN_JUMPS",
    ...
    "PolarA0_FENCE",
    "PolarA0_FOUND",
    "PolarA0_MISSION_FAIL",
    "PolarA0_MOUNT",
    "PolarA0_OPEN_CAR",
    "PolarA0_SWITCH_1",
    "PolarA1_FIGHT_LEAVE",
    "PolarA1_FIGHT_LEAVE_RESTART",
    "PolarA1_FIGHT_RESTART",
    "PolarA1_FIGHT_START",
    "PolarA1_HUSTLER",
    "PolarA1_MISSION_FAIL",
    "PolarA1_MISSION_START",
    "PolarA1_SPEED",
    "PolarA1_SPEED_RESTART",
    "PolarA1_STOP_TRACK",
    "PolarA1_WATER_ARRIVE",
    "PolarA2_ALERTED",
    "PolarA2_ATTACK_RT",
    "PolarA2_CUT_LAMAR_RT",
    "PolarA2_END_ON_FOOT",
    "PolarA2_END_VEHICLE",
    "PolarA2_FAIL",
    "PolarA2_FLEE_RT",
    "PolarA2_GET_TO_LAMAR",
    "PolarA2_GOT_LAMAR",
    "PolarA2_HEAD_TO_POS",
    "PolarA2_IN_POSITION",
    "PolarA2_RETURN_LAMAR",
    "PolarA2_START",
    "GA_KILL_ALERTED",
    "GA_KILL_ALERTED_RS",
    "GA_KILL_COMPLETE",
...
local z = module("Polar-weapons", "cfg/weapons")
RageUI.CreateWhile(
    1.0,
    true,
    function()
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        RMenu:Get("devmenu", "nativesounds")
                    )
                    RageUI.Button(
                        "Music Events",
                        nil,
                    ...
                    RageUI.Button(
                        ...
                        RMenu:Get("devmenu", "propplacement")
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                tPolar.clientPrompt(
                                    "Customization [JSON]",
                                    json.encode(tPolar.getCustomization()),
                                    function()
                                    end
                                )
                            end
                        ...
                        function(A, B, C)
                            if C then
                                tPolar.clientPrompt(
                                    ...
                                    "",
                                    function(D)
                                        tPolar.setCustomization(json.decode(D))
                                    end
                                )
                            end
                        end
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local E = tPolar.getPlayerCoords()
                                tPolar.clientPrompt(
                                    "Spawn Code",
                                    "",
                                    function(F)
                                        tPolar.spawnVehicle(
                                            ...
                                            E.y,
                                            E.z,
                                            GetEntityHeading(tPolar.getPlayerPed()),
                                            true,
                                            true,
                                            true
                                        )
                        ...
                        function(A, B, C)
                            if C then
                                ...
                                tPolar.clientPrompt(
                                    ...
                                    "",
                                    function(G)
                                        local H = tPolar.loadModel(G)
                                        if H then
                                            local I =
                                                GetEntityCoords(PlayerPedId()) +
                                                GetEntityForwardVector(PlayerPedId()) * 2.0
                                            CreateObject(H, I.x, I.y, I.z, false, false, false)
                        ...
                        function(A, B, C)
                            if C then
                                ...
                                tPolar.clientPrompt(
                                    ...
                                    "",
                                    function(G)
                                        local H = tPolar.loadModel(tonumber(G))
                                        if H then
                                            local I =
                                                GetEntityCoords(PlayerPedId()) +
                                                GetEntityForwardVector(PlayerPedId()) * 2.0
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerEvent("Polar:toggleTrafficMenu")
                            end
                        end
                    )
                    RageUI.Button(
                    ...
                    --     function(A, B, C)
                    --         if C then
                    --             TriggerServerEvent("Polar:jobSelector")
                    --         end
                    --     end
                    -- )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = tPolar.loadModel("a_f_m_beach_01")
                                local K = tPolar.getPlayerCoords()
                                CreatePed(1, J, K.x, K.y, K.z, 0.0, true, true)
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = tPolar.loadModel("s_m_m_pilot_02")
                                local K = tPolar.getPlayerCoords()
                                CreatePed(1, J, K.x, K.y, K.z, 0.0, true, true)
                                SetModelAsNoLongerNeeded(J)
                            end
                                        ...
                                        tPolar.clientPrompt(
                                            ...
                                            function(L)
                                                ...
                                                tPolar.clientPrompt(
                                                    ...
                                                    function(M)
                                                        Wait(100)
                                                        tPolar.gridPositionSaver(F, L, M)
                                                    end
                                                )
                                            end
                                        )
                                ...
                                tPolar.clientPrompt(
                                    ...
                                    function(O)
                                        if O == "" then
                                            ...
                                            if not IsModelInCdimage(P) or not IsModelValid(P) then
                                                notify(string.format("Model %s is not valid", O))
                                                return
                                            end
                                            if not j then
                                                w()
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                ExecuteCommand("clearvehicles")
                                notify("~g~Triggered clear vehicles")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                ExecuteCommand("clearobjects")
                                notify("~g~Triggered clear objects")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                ExecuteCommand("clearpeds")
                                notify("~g~Triggered clear peds")
                            end
                        end
                    )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                tPolar.clientPrompt(
                                    ...
                                    function(P)
                                        if P ~= nil and P ~= "" then
                                            P = "WEAPON_" .. string.upper(P)
                                            tPolar.giveWeapons({[P] = {ammo = 250}})
                                        end
                                    end
                                )
                            end
                    ...
                    for R, S in pairs(e) do
                        ...
                        if t == nil then
                            RageUI.ButtonWithStyle(
                                ...
                                function(A, B, C)
                                    if C then
                                        RMenu:Get("devmenu", "animations2"):SetTitle(R)
                                        RMenu:Get("devmenu", "animations2").MetaData = {dict = R, anims = S}
                                    end
                                end,
                                ...
                                if string.match(t, S[c]) then
                                    RageUI.ButtonWithStyle(
                                        ...
                                        function(A, B, C)
                                            if C then
                                                u(R)
                                                TaskPlayAnim(tPolar.getPlayerPed(), R, S[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
                                                RemoveAnimDict(R)
                                            end
                                        end
                                    )
                    ...
                    for c = 1, #U.anims do
                        RageUI.ButtonWithStyle(
                            ...
                            function(A, B, C)
                                if C then
                                    u(U.dict)
                                    TaskPlayAnim(tPolar.getPlayerPed(), U.dict, U.anims[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
                                    RemoveAnimDict(U.dict)
                                end
                            end
                        )
                    end
                ...
                function()
                    for R, S in pairs(f) do
                        RageUI.ButtonWithStyle(
                            ...
                            function(A, B, C)
                                if C then
                                    RMenu:Get("devmenu", "ipls2"):SetTitle(R)
                                    RMenu:Get("devmenu", "ipls2").MetaData = {ipls = S}
                                end
                            end,
        ...
        -- if RageUI.Visible(RMenu:Get("devmenu", "ipls2")) then
        --     RageUI.DrawContent(
        --         {header = true, glare = false, instructionalButton = false},
        --         function(U)
        --             for R, S in pairs(U.ipls) do
        --                 RageUI.ButtonWithStyle(
        --                     R,
        --                     nil,
        --                     {},
        ...
        --                     function(A, B, C)
        --                         if C then
        --                             RMenu:Get("devmenu", "ipls3").MetaData = {ipls = S}
        --                         end
        --                     end,
        --                     RMenu:Get("devmenu", "ipls3")
        --                 )
        --             end
        --         end
        --     )
        -- end
        -- if RageUI.Visible(RMenu:Get("devmenu", "ipls3")) then
        --     RageUI.DrawContent(
        --         {header = true, glare = false, instructionalButton = false},
        --         function(U)
        --             for R, S in pairs(U.ipls) do
        ...
        --                     function(A, B, C)
        --                         if C then
        --                             for x, V in pairs(U.ipls) do
        --                                 RemoveIpl(V[2])
        --                             end
        --                             RequestIpl(S[2])
        --                             SetEntityCoords(tPolar.getPlayerPed(), tPolar.getPlayerCoords())
        --                             local K = tPolar.getPlayerCoords()
        --                             local W = GetInteriorAtCoords(K.x, K.y, K.z)
        --                             tPolar.notify("[Polar] Ipl ~g~" .. S[1] .. "(" .. S[2] .. ")" .. " ~s~loaded")
        --                         end
        --                     end
        --                 )
        --             end
        ...
        --                     function(A, B, C)
        --                         if C then
        --                             RMenu:Get("devmenu", "tplocations2").MetaData = {tps = S}
        --                         end
        --                     end,
        ...
        --     )
        -- end
        -- if RageUI.Visible(RMenu:Get("devmenu", "tplocations2")) then
        --     RageUI.DrawContent(
        --         {header = true, glare = false, instructionalButton = false},
        --         function(U)
        --             for R, S in pairs(U.tps) do
        --                 RageUI.ButtonWithStyle(
        --                     S[1],
        --                     S[5],
        --                     {},
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(A, B, C)
                                if C then
                                    ...
                                    ReleaseSoundId(k)
                                    k = GetSoundId()
                                    PlaySoundFrontend(k, S[1], S[2], S[3])
                                end
                            end
                        )
                    end
...
function AddPropToPlayer(Y, Z, _, a0, a1, a2, a3, a4)
    local a5 = PlayerPedId()
    local a6, a7, a8 = table.unpack(GetEntityCoords(a5))
    tPolar.loadModel(Y)
    local a9 = CreateObject(GetHashKey(Y), a6, a7, a8 + 0.2, true, true, true)
    AttachEntityToEntity(a9, a5, GetPedBoneIndex(a5, Z), _, a0, a1, a2, a3, a4, true, true, false, true, 1, true)
...
function tPolar.gridPositionSaver(aa, L, M)
    tPolar.notify("pick 1st coord, press Y when done")
    ...
    Wait(250)
    tPolar.notify("pick 2nd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    local ac = GetEntityCoords(PlayerPedId())
    Wait(250)
    tPolar.notify("pick 3rd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    local ad = GetEntityCoords(PlayerPedId())
    local ae = {}
    for c = 0, M - 1, 1 do
        for af = 0, L - 1, 1 do
            local ag = ac - ab
            local ah = ad - ab
            local ai =
                ab + vector3(ah.x / L * af, ah.y / L * af, ah.z / L * af) +
                vector3(ag.x / M * c, ag.y / M * c, ag.z / M * c)
            tPolar.loadModel("a_m_m_fatlatin_01")
            local aj = tPolar.spawnVehicle(aa, ai.x, ai.y, ai.z, heading, false, false, false)
            CreatePedInsideVehicle(aj, 0, "a_m_m_fatlatin_01", -1, false, false)
            SetModelAsNoLongerNeeded("a_m_m_fatlatin_01")
            table.insert(ae, ai)
        end
    end
    for c = 1, #ae, 1 do
        print("vector4(" .. ae[c].x .. "," .. ae[c].y .. "," .. ae[c].z .. "," .. heading .. "),")
    end
end
Citizen.CreateThread(
    function()
        while true do
            Citizen.Wait(0)
            if a then
                local ak = IsPedInAnyVehicle(PlayerPedId()) and GetVehiclePedIsIn(PlayerPedId(), false) or PlayerPedId()
                local a6, a7, a8 = table.unpack(GetEntityCoords(ak, true))
                roundx = tonumber(string.format("%.2f", a6))
                roundy = tonumber(string.format("%.2f", a7))
                roundz = tonumber(string.format("%.2f", a8))
                tPolar.DrawText(0.32, 0.00, "X:~s~ " .. roundx, 0.4)
                tPolar.DrawText(0.38, 0.00, "Y:~s~ " .. roundy, 0.4)
                tPolar.DrawText(0.445, 0.00, "Z:~s~ " .. roundz, 0.4)
                heading = GetEntityHeading(ak)
                roundh = tonumber(string.format("%.2f", heading))
                tPolar.DrawText(0.50, 0.00, "H:~s~ " .. roundh, 0.4)
                local al, am, an = table.unpack(GetEntityRotation(PlayerPedId(), 1))
                tPolar.DrawText(0.38, 0.03, "RX:~s~ " .. tonumber(string.format("%.2f", al)), 0.4)
                tPolar.DrawText(0.44, 0.03, "RY:~s~ " .. tonumber(string.format("%.2f", am)), 0.4)
                tPolar.DrawText(0.495, 0.03, "RZ:~s~ " .. tonumber(string.format("%.2f", an)), 0.4)
                speed = GetEntitySpeed(PlayerPedId())
                rounds = tonumber(string.format("%.2f", speed))
                tPolar.DrawText(0.40, 0.92, "Player Speed: ~s~" .. rounds, 0.4)
                health = GetEntityHealth(PlayerPedId())
                tPolar.DrawText(0.40, 0.95, "Player Health: ~s~" .. health, 0.4)
                camRotX = GetGameplayCamRot(2).x
                tPolar.DrawText(0.36, 0.88, "CR X: ~s~" .. tonumber(string.format("%.2f", camRotX)), 0.4)
                camRotY = GetGameplayCamRot(2).y
                tPolar.DrawText(0.44, 0.88, "CR Y: ~s~" .. tonumber(string.format("%.2f", camRotY)), 0.4)
                camRotZ = GetGameplayCamRot(2).z
                tPolar.DrawText(0.51, 0.88, "CR Z: ~s~" .. tonumber(string.format("%.2f", camRotZ)), 0.4)
                ...
                if IsPedInAnyVehicle(PlayerPedId(), 1) then
                    ...
                    tPolar.DrawText(0.015, 0.76, "Engine Health: ~s~" .. vehenground, 0.4)
                    tPolar.DrawText(0.015, 0.73, "Body Health: ~s~" .. vehbodround, 0.4)
                    tPolar.DrawText(
                        0.015,
                        0.70,
                        "Vehicle Fuel: ~s~" ..
...
ao.min = nil
ao.max = nil
ao.selectedType = "NONE"
ao.selectedDistance = 0.0
local function ap(aq, ar)
    local as = 0.001
    local at = {
        vector3(aq.x - as, aq.y - as, aq.z - as),
        vector3(ar.x + as, aq.y - as, aq.z - as),
        vector3(ar.x + as, ar.y + as, aq.z - as),
        vector3(aq.x - as, ar.y + as, aq.z - as),
        vector3(aq.x - as, aq.y - as, ar.z + as),
        vector3(ar.x + as, aq.y - as, ar.z + as),
        vector3(ar.x + as, ar.y + as, ar.z + as),
        vector3(aq.x - as, ar.y + as, ar.z + as)
    }
    return at
end
local function au(at)
    local av = {
        {at[3], at[2], at[1]},
        {at[4], at[3], at[1]},
        {at[5], at[6], at[7]},
...
local function aw(av)
    for c, ax in ipairs(av) do
        local ay = ax[1].x
        local az = ax[1].y
        local aA = ax[1].z
        local aB = ax[2].x
        ...
        local aF = ax[3].y
        local aG = ax[3].z
        DrawPoly(ay, az, aA, aB, aC, aD, aE, aF, aG, c * 19, 255 - c * 19, 0, 200)
    end
end
local function aH(aq, ar)
    local at = ap(aq, ar)
    local av = au(at)
    aw(av)
end
local function aI()
    local aJ = GetFrameTime()
    local aK, aL, aM, aN = GetCamMatrix(ao.camera)
    local aO = GetCamRot(ao.camera, 2)
    DisableControlAction(0, 32, true)
    if IsDisabledControlPressed(0, 32) then
        aN = aN + aL * ao.moveSpeed * aJ
    end
    DisableControlAction(0, 34, true)
    if IsDisabledControlPressed(0, 34) then
        aN = aN - aK * ao.moveSpeed * aJ
    end
    ...
    local aP = -GetDisabledControlNormal(0, 1) * ao.mouseSpeed * aJ
    aO = aO + vector3(0.0, 0.0, aP)
    DisableControlAction(0, 2, true)
    local aQ = -GetDisabledControlNormal(0, 2) * ao.mouseSpeed * aJ
    if math.abs(aO.x + aQ) < 70.0 then
        aO = aO + vector3(aQ, 0.0, 0.0)
    end
    SetCamCoord(ao.camera, aN.x, aN.y, aN.z)
    SetCamRot(ao.camera, aO.x, aO.y, aO.z, 2)
end
local function aR()
    DisableControlAction(0, 24, true)
    if IsDisabledControlPressed(0, 24) then
        if ao.selectedType == "NONE" then
            local aS, a6, a7 = GetScreenCoordFromWorldCoord(ao.min.x, ao.min.y, ao.min.z)
            if aS and math.abs(a6 - 0.5) < 0.02 and math.abs(a7 - 0.5) < 0.05 then
                ao.selectedType = "MIN"
                ao.selectedDistance = #(GetCamCoord(ao.camera) - ao.min)
                return
            end
            local aS, a6, a7 = GetScreenCoordFromWorldCoord(ao.max.x, ao.max.y, ao.max.z)
            if aS and math.abs(a6 - 0.5) < 0.02 and math.abs(a7 - 0.5) < 0.05 then
                ao.selectedType = "MAX"
                ao.selectedDistance = #(GetCamCoord(ao.camera) - ao.max)
                return
            end
        else
            local aK, aL, aM, aN = GetCamMatrix(ao.camera)
            if ao.selectedType == "MIN" then
                ao.min = aN + aL * ao.selectedDistance
            else
                ao.max = aN + aL * ao.selectedDistance
            end
        end
    else
        ao.selectedType = "NONE"
...
function toggleBoundsEditor()
    if ao.camera then
        ...
        SetCamActive(ao.camera, false)
        DestroyCam(ao.camera, false)
        ao.camera = nil
        tPolar.clientPrompt(
            "Bounds",
            tostring(ao.min) .. ", " .. tostring(ao.max),
            function()
            end
        )
        ...
        ao.camera = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", aW.x, aW.y, aW.z, 0.0, 0.0, 0.0, 70.0, false, false)
        SetCamActive(ao.camera, true)
        RenderScriptCams(true, false, 0, false, false)
        ao.min = GetOffsetFromEntityInWorldCoords(aV, -10.0, -10.0, 0.0)
        ao.max = GetOffsetFromEntityInWorldCoords(aV, 10.0, 10.0, 20.0)
        Citizen.CreateThread(
            function()
                while ao.camera do
                    aU()
...
function tPolar.createDebugObject(Q)
    local aX = tPolar.loadModel(Q)
    local aY = GetEntityCoords(PlayerPedId())
    local aZ = CreateObject(aX, aY.x, aY.y, aY.z - 1, false, false, true)
    SetEntityInvincible(aZ, true)
    FreezeEntityPosition(aZ, true)
    SetEntityAlpha(aZ, 100, false)
    SetModelAsNoLongerNeeded(aX)
    local a_ = true
    while a_ do
        local b0 = GetEntityCoords(aZ)
        local b1 = GetEntityHeading(aZ)
        if IsControlPressed(0, 121) then
            SetEntityCoordsNoOffset(aZ, b0.x, b0.y, b0.z + 0.01)
        end
        if IsControlPressed(0, 178) then
            SetEntityCoordsNoOffset(aZ, b0.x, b0.y, b0.z - 0.01)
        end
        if IsControlPressed(0, 111) then
            SetEntityCoordsNoOffset(aZ, b0.x, b0.y + 0.01, b0.z)
        end
        if IsControlPressed(0, 110) then
            SetEntityCoordsNoOffset(aZ, b0.x, b0.y - 0.01, b0.z)
        end
        if IsControlPressed(0, 108) then
            SetEntityCoordsNoOffset(aZ, b0.x - 0.01, b0.y, b0.z)
        end
        if IsControlPressed(0, 107) then
            SetEntityCoordsNoOffset(aZ, b0.x + 0.01, b0.y, b0.z)
        end
        if IsControlPressed(0, 117) then
            SetEntityHeading(aZ, b1 + 0.1)
        end

local a = false
function func_ptt()
    if globalOnPoliceDuty and tPolar.canAnim() and not noclipActive and tPolar.isInRadioChannel() then
        local b = tPolar.getPlayerPed()
        local c = tPolar.getPlayerId()
        if a then
            ...
            if
             ...
             then
                ...
                tPolar.loadAnimDict("random@arrests")
...
tPolar.createThreadOnTick(func_ptt)

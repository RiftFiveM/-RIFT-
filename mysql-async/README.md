...
This mysql-async Library for rift intends to provide function to connect to a MySQL in a Sync and Async way.

### Documentation

Check out https://brouznouf.github.io/rift-mysql-async/ for a complete documentation.
...
### Changelog
For a detailed changelog either check the commits or read https://github.com/brouznouf/rift-mysql-async/releases

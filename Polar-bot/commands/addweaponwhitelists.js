...
exports.runcmd = (fivemexports, client, message, params) => {
    if (!params[0] || !parseInt(params[0]) || !params[1] || !params[2] || !params[3] || !parseInt(params[4]) || !params[5] || !params[6] ) {
        let embed = {
            ...
            "description": "Incorrect Usage\n\nCorrect Usage" + process.env.PREFIX + '\n`!addwhitelist [permid] [Weapon name] [Weapon Spawncode] [Weapon price] [Weapon Category] [Is weapon owner]`',
            "color": 0xed4245,
        }
    ...
    let owner = ''
    fivemexports.ghmattimysql.execute("INSERT INTO Polar_weapon_whitelists (user_id, name, gunhash, price, category, owner) VALUES(?, ?,?,?,?,?)", [params[0], name, params[3], params[4], params[5], params[6]], (result) => {
        if (result) {
            if (params[6] == 1) {
                owner = 'True'
            }

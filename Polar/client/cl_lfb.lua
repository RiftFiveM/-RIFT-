...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight(),"banners", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tPolar.getRageUIMenuWidth(), tPolar.getRageUIMenuHeight(), "banners", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tPolar.getRageUIMenuWidth(),tPolar.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tPolar.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tPolar.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tPolar.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("Polar:updateFireOptions", l, n, m)
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("Polar:stopAllFires")
--                         end
--                     end
--                 )
--             end,
...
--                             TriggerServerEvent("Polar:updateFireTableServer", s, u, false, false, true)
--                         end
--                     end
--                 )
--             end,
...
--     end
-- )
-- TriggerServerEvent("Polar:receiveLFBTablesServer")
-- local v = {}
-- local w = {}
-- local x = {}
-- local y = {}
...
--     return tPolar.generateUUID("fire", 20, "alphanumeric")
-- end
-- RegisterNetEvent("Polar:startFireMenu",function(F, G, H)
--     RageUI.ActuallyCloseAll()
--     RageUI.Visible(RMenu:Get("lfb", "tools"), false)
--     RageUI.Visible(RMenu:Get("lfb", "main"), false)
--     RageUI.Visible(RMenu:Get("lfb", "water"), false)
...
-- RegisterNetEvent("Polar:receiveLFBTables",function(I, J, K, L, M, N, O, P, Q)
--     v = I
--     w = J
--     x = K
--     y = L
...
-- RegisterNetEvent("Polar:updateFireTable",function(R, S, T, U)
--     if T then
...
--     v[R].active = true
--     tPolar.loadPtfx(f[v[R].type].dict)
...
--         tPolar.loadPtfx(E[f[v[R].type].smokeType].dict)
...
-- }
-- RegisterNetEvent("Polar:updateSupplyLineTable",function(R, S, T)
--     if T then
--         w[R] = nil
--         return
--     end
...
--     local a4 = tPolar.getPlayerPed()
--     local ae = tPolar.getPlayerVehicle()
--     if ae ~= 0 then
--         tPolar.notify("~r~Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tPolar.notify("~r~Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                         Wait(0)
--                     end
--                     TriggerServerEvent("Polar:createLFBPropLog", "Supply Line", GetEntityCoords(aj, true))
...
--                     w[af] = {af, al, t}
--                     TriggerServerEvent("Polar:updateSupplyLineTable", af, w[af], false)
--                     SetModelAsNoLongerNeeded(a2)
--                     tPolar.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tPolar.notify("~r~Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
--                 TriggerServerEvent("Polar:updateSupplyLineTable", af, w[af], true)
--                 TriggerServerEvent("Polar:lfbDeleteSupplyLine", w[af][2])
--                 TriggerServerEvent("Polar:removeVehicleStablisers", af)
--                 w[af] = nil
--                 tPolar.notify("~g~Success~w~: Supply line removed")
--             else
--                 tPolar.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tPolar.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
-- local ap = false
-- RegisterNetEvent("Polar:hoseUpdate",function(aq, ar, T)
--     if T then
--         if an[aq] ~= nil then
--             an[aq][3] = false
--             if an[aq][4] ~= nil then
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tPolar.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tPolar.notify("~r~Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tPolar.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tPolar.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tPolar.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
...
-- function handleHose()
--     local a4 = tPolar.getPlayerPed()
--     local aq = tPolar.getNetId(a4, "handleHose()")
--     TriggerServerEvent("Polar:hoseUpdateServer", aq, 0.0, false)
--     ap = true
--     while ap do
--         DisableControlAction(0, 24, true)
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tPolar.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tPolar.getPlayerId()) or not X and _ < 1 then
--             ap = false
--             TriggerServerEvent("Polar:hoseUpdateServer", aq, 0.0, true)
--         end
--         Wait(0)
--     end
-- end
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tPolar.getPlayerPed(), 0.0, 3.0, 0.5)
--             if #(a6 - i.coords) < 7.0 then
--                 local av = math.random(1, f[i.type].chance)
--                 if av == 1 then
--                     local H = i.size * 0.92
--                     if H < 0.5 then
--                         TriggerServerEvent("Polar:updateFireTableServer", h, v[h], true, false)
--                         Wait(5000)
--                     else
--                         v[h].size = H
--                         TriggerServerEvent("Polar:updateFireTableServer", h, v[h], false, true)
--                         Wait(5000)
--                     end
--                     break
--                 end
...
--     end
-- end
-- RegisterNetEvent("Polar:updateMonitorsTable",function(R, S, T)
--     if T then
--         x[R] = nil
--         return
--     end
...
-- RegisterNetEvent("Polar:toggleWaterClient",function(R)
--     if x[R] ~= nil then
--         x[R][4] = not x[R][4]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("Polar:createLFBPropLog", "Water Monitor", GetEntityCoords(aj, true))
...
--         TriggerServerEvent("Polar:updateMonitorsTable", al, x[al], false)
--         SetModelAsNoLongerNeeded(ax)
--         tPolar.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tPolar.notify("~r~Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tPolar.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("Polar:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tPolar.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tPolar.notify("~r~Error~w~: No water monitor found")
--         end
--     end
-- end
-- RegisterNetEvent("Polar:adjustPitchClient",function(R, az)
--     if aw[R] ~= nil and aw[R].handle ~= nil and DoesParticleFxLoopedExist(aw[R].handle) then
--         local t = x[R][2]
--         StopParticleFxLooped(aw[R].handle, false)
--         StopParticleFxLooped(aw[R].handle2, false)
...
--                                 end
--                                 if az ~= 0.0 then
--                                     TriggerServerEvent("Polar:adjustPitchServer", h, az)
--                                     Wait(1000)
--                                 end
--                                 DisableControlAction(0, 38, true)
--                                 if IsDisabledControlPressed(0, 38) then
--                                     pressed = true
--                                     TriggerServerEvent("Polar:toggleWaterServer", h)
--                                     tPolar.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tPolar.notify("~r~Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tPolar.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tPolar.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tPolar.notify("~r~Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tPolar.notify("~r~Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     end
-- end
-- tPolar.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
-- RegisterNetEvent("Polar:toggleWaterTents",function(R)
--     if y[R] ~= nil then
--         y[R][8] = not y[R][8]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("Polar:createLFBPropLog", "Decontamination Tent", GetEntityCoords(aj, true))
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         SetEntityHeading(aj, GetEntityHeading(a4))
...
--         TriggerServerEvent("Polar:updateTentsTable", al, y[al], false)
--         SetModelAsNoLongerNeeded(aK)
--         tPolar.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tPolar.notify("~r~Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tPolar.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("Polar:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tPolar.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tPolar.notify("~r~Error~w~: No decontamination tent found")
--         end
--     end
-- end
-- RegisterNetEvent("Polar:updateTentsTable",function(R, S, T)
--     if T then
--         y[R] = nil
--         return
--     end
...
--                     DisableControlAction(0, 38, true)
--                     if IsDisabledControlPressed(0, 38) then
--                         TriggerServerEvent("Polar:toggleWaterTents", h)
--                         tPolar.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
-- RegisterNetEvent("Polar:updateCushionsTable",function(R, S, T)
--     if T then
--         z[R] = nil
--         return
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("Polar:createLFBPropLog", "Rescue Cushion", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
...
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         z[al] = {al, a6}
--         TriggerServerEvent("Polar:updateCushionsTable", al, z[al], false)
--         SetModelAsNoLongerNeeded(aR)
--         tPolar.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             TriggerServerEvent("Polar:deleteProp", z[ay][1])
--             local aj = tPolar.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("Polar:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tPolar.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tPolar.notify("~r~Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tPolar.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tPolar.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tPolar.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tPolar.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
-- end
-- )
-- RegisterNetEvent("Polar:updateStabilisersTable",function(R, S, T)
--     if T then
--         A[R] = nil
--         return
--     end
--     A[R] = S
-- end)
-- RegisterNetEvent("Polar:updateFansTable",function(R, S, T)
--     if T then
--         B[R] = nil
--         return
--     end
--     B[R] = S
-- end)
-- RegisterNetEvent("Polar:stopRtcParticles",function(t)
--     Wait(20 * 1000)
-- end)
...
--     if not a then
--         tPolar.loadModel(aV)
--         tPolar.loadAnimDict("weapons@heavy@minigun")
...
--             TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(aW))
--             DetachEntity(a4)
--             DetachEntity(aW)
--             DeleteEntity(aW)
--             ClearPedTasks(a4)
...
--                             TriggerServerEvent("Polar:rtcOpenDoor", ba, ak[b7][2], tPolar.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("Polar:rtcOpenDoor", ba, ak[b7][2], tPolar.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     )
-- end
-- RegisterNetEvent("Polar:rtcOpenDoor",function(ba, ak, t, bb)
--     local ae = tPolar.getObjectId(ba, "Polar:rtcOpenDoor")
...
--     end
-- end)
-- RegisterNetEvent("Polar:spreadersSound",function(t)
--     local bc = tPolar.getPlayerCoords()
--     local V = #(t - bc)
--     if V < 15.0 then
...
--         if ad then
--             if ag then
--                 tPolar.notify("~r~Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tPolar.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("Polar:createLFBPropLog", "Vehicle Stablisers", GetEntityCoords(aj, true))
--                 SetEntityCollision(aj, false, true)
...
--                 A[af] = {af, al, bl}
--                 TriggerServerEvent("Polar:updateStabilisersTable", af, A[af], false)
--                 SetModelAsNoLongerNeeded(bd)
--                 tPolar.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tPolar.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tPolar.getObjectId(A[af][3], "handleStabilisers 2")
--                 TriggerServerEvent("Polar:updateStabilisersTable", af, A[af], true)
--                 if DoesEntityExist(aj) then
--                     TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                     DeleteEntity(aj)
--                 end
--                 if DoesEntityExist(bg) then
--                     TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(bg))
--                     DeleteEntity(bg)
--                 end
--                 TriggerServerEvent("Polar:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tPolar.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tPolar.notify("~r~Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tPolar.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- RegisterNetEvent("Polar:removeVehicleStablisers",function(bm)
...
--             Wait(0)
--         end
--         TriggerServerEvent("Polar:createLFBPropLog", "Extractor Fan", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         B[al] = {al, a6}
--         TriggerServerEvent("Polar:updateFansTable", al, B[al], false)
--         SetModelAsNoLongerNeeded(bn)
--         tPolar.notify("~g~Success~w~: Fan setup")
--         TriggerServerEvent("Polar:stopRtcParticles", t)
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             local aj = tPolar.getObjectId(B[ay][1], "handleFan")
--             TriggerServerEvent("Polar:updateFansTable", ay, B[ay], true)
--             if DoesEntityExist(aj) then
--                 TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                 DeleteEntity(aj)
--             end
--             B[ay] = nil
--             tPolar.notify("~g~Success~w~: Fan removed")
--         else
--             tPolar.notify("~r~Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     end
-- end)
-- RegisterNetEvent("Polar:updateJackTable",function(R, S, T)
--     if T then
--         C[R] = nil
--         return
--     end
--     C[R] = S
-- end)
-- RegisterNetEvent("Polar:updateChockTable",function(R, S, T)
--     if T then
--         D[R] = nil
--         return
--     end
--     D[R] = S
-- end)
-- RegisterNetEvent("Polar:toggleChockWheels",function(af)
--     local ae = tPolar.getObjectId(af, "Polar:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tPolar.notify("~r~Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
--                 if not br then
--                     C[af][5] = true
--                     TriggerServerEvent("Polar:updateJackTable", af, C[af], false)
--                     local bs = tPolar.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tPolar.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tPolar.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tPolar.notify("~r~Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("Polar:createLFBPropLog", "Inflatable Jack", GetEntityCoords(bs, true))
...
--                 tPolar.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tPolar.notify("~r~Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tPolar.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tPolar.getObjectId(C[af][3], "handleJack 4")
--                     TriggerServerEvent("Polar:updateJackTable", af, C[af], true)
--                     if DoesEntityExist(bs) then
--                         TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                         DeleteEntity(bs)
--                     end
--                     if DoesEntityExist(bt) then
--                         TriggerServerEvent("Polar:deleteProp", NetworkGetNetworkIdFromEntity(bt))
--                         DeleteEntity(bt)
--                     end
--                     TriggerServerEvent("Polar:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tPolar.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tPolar.notify("~r~Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tPolar.notify("~r~Error~w~: No vehicle found")
...
--     tPolar.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--                 bz = 0.8
--             end
--             TriggerServerEvent("Polar:lfbHandlingLifting", bm, by, bz)
--         end
...
--             TriggerServerEvent("Polar:lfbLiftingFreeze", bm)
--             C[af][5] = false
--             C[af][4] = bz
--             TriggerServerEvent("Polar:updateJackTable", af, C[af], false)
--             tPolar.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
-- end
-- RegisterNetEvent("Polar:lfbHandlingLifting",function(bm, by, bz)
...
-- end)
-- RegisterNetEvent("Polar:lfbLiftingFreeze",function(bm)
...
--         if ad then
--             if ag then
--                 tPolar.notify("~r~Error~w~: This vehicle already has chocks setup")
--             else
--                 local bu = GetEntityCoords(ae)
--                 ResetVehicleWheels(ae, true)
--                 tPolar.loadModel(bB)
--                 TriggerServerEvent("Polar:toggleChockWheels", af)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("Polar:createLFBPropLog", "Air Chocks", GetEntityCoords(bC, true))
--                 local bh = GetEntityHeading(ae)
...
--                 D[af] = {af, bK, bL, bM, bN}
--                 TriggerServerEvent("Polar:updateChockTable", af, D[af], false)
--                 SetModelAsNoLongerNeeded(bB)
--                 TaskGoStraightToCoord(tPolar.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tPolar.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tPolar.getObjectId(D[af][2], "chock1")
--                 local bD = tPolar.getObjectId(D[af][3], "chock2")
--                 local bE = tPolar.getObjectId(D[af][4], "chock3")
--                 local bF = tPolar.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                     DeleteEntity(bF)
--                 end
--                 TriggerServerEvent("Polar:updateChockTable", af, D[af], true)
--                 TriggerServerEvent("Polar:removeVehicleStablisers", af)
--                 tPolar.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tPolar.notify("~r~Error~w~: No car chocks found")
--             end
--         end
--     else
--         tPolar.notify("~r~Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tPolar.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tPolar.notify("~r~Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tPolar.getPlayerPed()
--     local t = tPolar.getPlayerCoords()
--     TriggerServerEvent("Polar:spawnThrowBag",t,tPolar.getNetId(bR, "spawnRope(entity)"),tPolar.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tPolar.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("Polar:spawnThrowBag",function(t, aq, bT)
--     local a4 = tPolar.getPlayerPed()
--     local bv = tPolar.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tPolar.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tPolar.getObjectId(bT, "spawnThrowBag 2")

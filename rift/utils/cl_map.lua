globalBlips = {}
function tRIFT.addBlip(a, b, c, d, e, f, g, h)
...
function tRIFT.removeBlip(j)
    RemoveBlip(j)
end
function tRIFT.removeBlipAtCoords(x,y,z) -- used to remove green house blips for everyone when purchased
...
local k = {}
function tRIFT.setNamedBlip(l, a, b, c, d, e, f, g)
    tRIFT.removeNamedBlip(l)
    k[l] = tRIFT.addBlip(a, b, c, d, e, f, g)
    return k[l]
end
function tRIFT.removeNamedBlip(l)
    if k[l] ~= nil then
        tRIFT.removeBlip(k[l])
        k[l] = nil
    end
end
function tRIFT.setGPS(a, b)
    SetNewWaypoint(a + 0.0001, b + 0.0001)
end
function tRIFT.setBlipRoute(j)
    SetBlipRoute(j, true)
end
local m = {}
...
local p = {}
local q = {}
function tRIFT.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    local I = {
...
function tRIFT.setNamedMarker(l, a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    tRIFT.removeNamedMarker(l)
    o[l] = tRIFT.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    return o[l]
end
function tRIFT.removeNamedMarker(l)
    if o[l] ~= nil then
        tRIFT.removeMarker(o[l])
        o[l] = nil
    end
end
local J = {}
...
Citizen.CreateThread(
    function()
        while true do
            q = tRIFT.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tRIFT.getNearbyMarkers()
    local N = {}
    local O = tRIFT.getPlayerCoords()
    local P = 0
...
function tRIFT.setArea(l, a, b, c, T, U)
...
RegisterCommand("nextblip",function()
    ...
    a4 = tRIFT.addBlip(1103.9739990234, 211.95138549805, -49.440101623535, a5, 0, "Chips Cashier", 0.8, true)
end)

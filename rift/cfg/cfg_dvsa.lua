    ...
    routes = {
        { -- test route 1 (bay park manoeuvre)
            ...
            { -- entering bypass
                ...
                limit = 30.0,
                action = function()
                    TriggerEvent("rift:PlaySound", "motorwayExplained")
            ...
            { -- bypass driving, hence high speed limit
                ...
                limit = 70.0,
                action = function()
                    TriggerEvent("rift:PlaySound", "leavingMotorwayTurningRight")
            ...
            },
            {
                ...
                limit = 30.0,
                action = function()
                    TriggerEvent("rift:PlaySound", "turningRightJunction")
            ...
            },
            {
                ...
                limit = 30.0,
                action = function()
                    TriggerEvent("rift:PlaySound", "driveToTopFloor")
                    tRIFT.notifyPicture(cfg.images.dict, cfg.images.govLarge, "Listen carefully for directions, drive to the top floor of the car park", "Reverse Park", "DVSA")
            ...
            },
            {
                ...
                limit = 30.0,
                action = function()
                    TriggerEvent("rift:PlaySound", "nowReversePark")
                    PlaySoundFrontend(-1, "Out_Of_Bounds_Timer", "DLC_HEISTS_GENERAL_FRONTEND_SOUNDS", 1)
                    tRIFT.notifyPicture(cfg.images.dict, cfg.images.govLarge, "Once at the top, you must reverse park in the marked bay.", "Reverse Park", "DVSA")
            ...
            },
            {
                ...
                action = function(currentTest)
                    ...
                    if not seriousIssued then
                        ...
                        local coordsDifference = math.abs(#(tRIFT.getPlayerCoords() - vector3(361.9121, -1673.248, 48.2865)))
                    ...
                    tRIFT.notifyPicture(cfg.images.dict, cfg.images.govLarge, "The reverse park exercise is now completed", "Reverse Park", "DVSA")
                    TriggerEvent("rift:PlaySound", "reverseParkComplete")
            ...
            },
            {
                ...
                action = function()
                    TriggerEvent("rift:PlaySound", "turningRightJunction")
                    tRIFT.notifyPicture(cfg.images.dict, cfg.images.govLarge, "We are turning right", "DVSA", "Directions")
                end
            },
            {
            ...
            },
            {
                ...
                action = function()
                    ...
                    Citizen.SetTimeout(50, function()
                        TriggerEvent("rift:PlaySound", "closeCall")

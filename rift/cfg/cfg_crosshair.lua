...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("rift_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("rift_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("rift_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("rift_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("rift_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("rift_crosshair_gap")
    ...
    local red = GetResourceKvpInt("rift_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("rift_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("rift_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('rift_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('rift_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('rift_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('rift_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('rift_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('rift_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('rift_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('rift_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('rift_crosshair_green', cfg.options.colour.green)
end

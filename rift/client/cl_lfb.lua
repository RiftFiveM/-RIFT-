...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight(),"banners", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tRIFT.getRageUIMenuWidth(), tRIFT.getRageUIMenuHeight(), "banners", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tRIFT.getRageUIMenuWidth(),tRIFT.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tRIFT.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tRIFT.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tRIFT.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("RIFT:updateFireOptions", l, n, m)
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("RIFT:stopAllFires")
--                         end
--                     end
--                 )
--             end,
...
--                             TriggerServerEvent("RIFT:updateFireTableServer", s, u, false, false, true)
--                         end
--                     end
--                 )
--             end,
...
--     end
-- )
-- TriggerServerEvent("RIFT:receiveLFBTablesServer")
-- local v = {}
-- local w = {}
-- local x = {}
-- local y = {}
...
--     return tRIFT.generateUUID("fire", 20, "alphanumeric")
-- end
-- RegisterNetEvent("RIFT:startFireMenu",function(F, G, H)
--     RageUI.ActuallyCloseAll()
--     RageUI.Visible(RMenu:Get("lfb", "tools"), false)
--     RageUI.Visible(RMenu:Get("lfb", "main"), false)
--     RageUI.Visible(RMenu:Get("lfb", "water"), false)
...
-- RegisterNetEvent("RIFT:receiveLFBTables",function(I, J, K, L, M, N, O, P, Q)
--     v = I
--     w = J
--     x = K
--     y = L
...
-- RegisterNetEvent("RIFT:updateFireTable",function(R, S, T, U)
--     if T then
...
--     v[R].active = true
--     tRIFT.loadPtfx(f[v[R].type].dict)
...
--         tRIFT.loadPtfx(E[f[v[R].type].smokeType].dict)
...
-- }
-- RegisterNetEvent("RIFT:updateSupplyLineTable",function(R, S, T)
--     if T then
--         w[R] = nil
--         return
--     end
...
--     local a4 = tRIFT.getPlayerPed()
--     local ae = tRIFT.getPlayerVehicle()
--     if ae ~= 0 then
--         tRIFT.notify("~r~Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tRIFT.notify("~r~Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                         Wait(0)
--                     end
--                     TriggerServerEvent("RIFT:createLFBPropLog", "Supply Line", GetEntityCoords(aj, true))
...
--                     w[af] = {af, al, t}
--                     TriggerServerEvent("RIFT:updateSupplyLineTable", af, w[af], false)
--                     SetModelAsNoLongerNeeded(a2)
--                     tRIFT.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tRIFT.notify("~r~Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
--                 TriggerServerEvent("RIFT:updateSupplyLineTable", af, w[af], true)
--                 TriggerServerEvent("RIFT:lfbDeleteSupplyLine", w[af][2])
--                 TriggerServerEvent("RIFT:removeVehicleStablisers", af)
--                 w[af] = nil
--                 tRIFT.notify("~g~Success~w~: Supply line removed")
--             else
--                 tRIFT.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tRIFT.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
-- local ap = false
-- RegisterNetEvent("RIFT:hoseUpdate",function(aq, ar, T)
--     if T then
--         if an[aq] ~= nil then
--             an[aq][3] = false
--             if an[aq][4] ~= nil then
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tRIFT.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tRIFT.notify("~r~Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tRIFT.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tRIFT.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tRIFT.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
--         tRIFT.loadPtfx("core")
...
-- function handleHose()
--     local a4 = tRIFT.getPlayerPed()
--     local aq = tRIFT.getNetId(a4, "handleHose()")
--     TriggerServerEvent("RIFT:hoseUpdateServer", aq, 0.0, false)
--     ap = true
--     while ap do
--         DisableControlAction(0, 24, true)
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tRIFT.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tRIFT.getPlayerId()) or not X and _ < 1 then
--             ap = false
--             TriggerServerEvent("RIFT:hoseUpdateServer", aq, 0.0, true)
--         end
--         Wait(0)
--     end
-- end
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tRIFT.getPlayerPed(), 0.0, 3.0, 0.5)
--             if #(a6 - i.coords) < 7.0 then
--                 local av = math.random(1, f[i.type].chance)
--                 if av == 1 then
--                     local H = i.size * 0.92
--                     if H < 0.5 then
--                         TriggerServerEvent("RIFT:updateFireTableServer", h, v[h], true, false)
--                         Wait(5000)
--                     else
--                         v[h].size = H
--                         TriggerServerEvent("RIFT:updateFireTableServer", h, v[h], false, true)
--                         Wait(5000)
--                     end
--                     break
--                 end
...
--     end
-- end
-- RegisterNetEvent("RIFT:updateMonitorsTable",function(R, S, T)
--     if T then
--         x[R] = nil
--         return
--     end
...
-- RegisterNetEvent("RIFT:toggleWaterClient",function(R)
--     if x[R] ~= nil then
--         x[R][4] = not x[R][4]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("RIFT:createLFBPropLog", "Water Monitor", GetEntityCoords(aj, true))
...
--         TriggerServerEvent("RIFT:updateMonitorsTable", al, x[al], false)
--         SetModelAsNoLongerNeeded(ax)
--         tRIFT.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tRIFT.notify("~r~Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tRIFT.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("RIFT:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tRIFT.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tRIFT.notify("~r~Error~w~: No water monitor found")
--         end
--     end
-- end
-- RegisterNetEvent("RIFT:adjustPitchClient",function(R, az)
--     if aw[R] ~= nil and aw[R].handle ~= nil and DoesParticleFxLoopedExist(aw[R].handle) then
--         local t = x[R][2]
--         StopParticleFxLooped(aw[R].handle, false)
--         StopParticleFxLooped(aw[R].handle2, false)
...
--                                 end
--                                 if az ~= 0.0 then
--                                     TriggerServerEvent("RIFT:adjustPitchServer", h, az)
--                                     Wait(1000)
--                                 end
--                                 DisableControlAction(0, 38, true)
--                                 if IsDisabledControlPressed(0, 38) then
--                                     pressed = true
--                                     TriggerServerEvent("RIFT:toggleWaterServer", h)
--                                     tRIFT.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tRIFT.notify("~r~Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tRIFT.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tRIFT.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tRIFT.notify("~r~Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tRIFT.notify("~r~Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     end
-- end
-- tRIFT.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
-- RegisterNetEvent("RIFT:toggleWaterTents",function(R)
--     if y[R] ~= nil then
--         y[R][8] = not y[R][8]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("RIFT:createLFBPropLog", "Decontamination Tent", GetEntityCoords(aj, true))
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         SetEntityHeading(aj, GetEntityHeading(a4))
...
--         TriggerServerEvent("RIFT:updateTentsTable", al, y[al], false)
--         SetModelAsNoLongerNeeded(aK)
--         tRIFT.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tRIFT.notify("~r~Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tRIFT.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("RIFT:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tRIFT.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tRIFT.notify("~r~Error~w~: No decontamination tent found")
--         end
--     end
-- end
-- RegisterNetEvent("RIFT:updateTentsTable",function(R, S, T)
--     if T then
--         y[R] = nil
--         return
--     end
...
--                     DisableControlAction(0, 38, true)
--                     if IsDisabledControlPressed(0, 38) then
--                         TriggerServerEvent("RIFT:toggleWaterTents", h)
--                         tRIFT.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
-- RegisterNetEvent("RIFT:updateCushionsTable",function(R, S, T)
--     if T then
--         z[R] = nil
--         return
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("RIFT:createLFBPropLog", "Rescue Cushion", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
...
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         z[al] = {al, a6}
--         TriggerServerEvent("RIFT:updateCushionsTable", al, z[al], false)
--         SetModelAsNoLongerNeeded(aR)
--         tRIFT.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             TriggerServerEvent("RIFT:deleteProp", z[ay][1])
--             local aj = tRIFT.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("RIFT:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tRIFT.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tRIFT.notify("~r~Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tRIFT.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tRIFT.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tRIFT.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tRIFT.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
-- end
-- )
-- RegisterNetEvent("RIFT:updateStabilisersTable",function(R, S, T)
--     if T then
--         A[R] = nil
--         return
--     end
--     A[R] = S
-- end)
-- RegisterNetEvent("RIFT:updateFansTable",function(R, S, T)
--     if T then
--         B[R] = nil
--         return
--     end
--     B[R] = S
-- end)
-- RegisterNetEvent("RIFT:stopRtcParticles",function(t)
--     Wait(20 * 1000)
-- end)
...
--     if not a then
--         tRIFT.loadModel(aV)
--         tRIFT.loadAnimDict("weapons@heavy@minigun")
...
--             TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(aW))
--             DetachEntity(a4)
--             DetachEntity(aW)
--             DeleteEntity(aW)
--             ClearPedTasks(a4)
...
--                             TriggerServerEvent("RIFT:rtcOpenDoor", ba, ak[b7][2], tRIFT.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("RIFT:rtcOpenDoor", ba, ak[b7][2], tRIFT.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     )
-- end
-- RegisterNetEvent("RIFT:rtcOpenDoor",function(ba, ak, t, bb)
--     local ae = tRIFT.getObjectId(ba, "RIFT:rtcOpenDoor")
...
--     end
-- end)
-- RegisterNetEvent("RIFT:spreadersSound",function(t)
--     local bc = tRIFT.getPlayerCoords()
--     local V = #(t - bc)
--     if V < 15.0 then
...
--         if ad then
--             if ag then
--                 tRIFT.notify("~r~Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tRIFT.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("RIFT:createLFBPropLog", "Vehicle Stablisers", GetEntityCoords(aj, true))
--                 SetEntityCollision(aj, false, true)
...
--                 A[af] = {af, al, bl}
--                 TriggerServerEvent("RIFT:updateStabilisersTable", af, A[af], false)
--                 SetModelAsNoLongerNeeded(bd)
--                 tRIFT.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tRIFT.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tRIFT.getObjectId(A[af][3], "handleStabilisers 2")
--                 TriggerServerEvent("RIFT:updateStabilisersTable", af, A[af], true)
--                 if DoesEntityExist(aj) then
--                     TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                     DeleteEntity(aj)
--                 end
--                 if DoesEntityExist(bg) then
--                     TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(bg))
--                     DeleteEntity(bg)
--                 end
--                 TriggerServerEvent("RIFT:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tRIFT.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tRIFT.notify("~r~Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tRIFT.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- RegisterNetEvent("RIFT:removeVehicleStablisers",function(bm)
...
--             Wait(0)
--         end
--         TriggerServerEvent("RIFT:createLFBPropLog", "Extractor Fan", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         B[al] = {al, a6}
--         TriggerServerEvent("RIFT:updateFansTable", al, B[al], false)
--         SetModelAsNoLongerNeeded(bn)
--         tRIFT.notify("~g~Success~w~: Fan setup")
--         TriggerServerEvent("RIFT:stopRtcParticles", t)
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             local aj = tRIFT.getObjectId(B[ay][1], "handleFan")
--             TriggerServerEvent("RIFT:updateFansTable", ay, B[ay], true)
--             if DoesEntityExist(aj) then
--                 TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                 DeleteEntity(aj)
--             end
--             B[ay] = nil
--             tRIFT.notify("~g~Success~w~: Fan removed")
--         else
--             tRIFT.notify("~r~Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     end
-- end)
-- RegisterNetEvent("RIFT:updateJackTable",function(R, S, T)
--     if T then
--         C[R] = nil
--         return
--     end
--     C[R] = S
-- end)
-- RegisterNetEvent("RIFT:updateChockTable",function(R, S, T)
--     if T then
--         D[R] = nil
--         return
--     end
--     D[R] = S
-- end)
-- RegisterNetEvent("RIFT:toggleChockWheels",function(af)
--     local ae = tRIFT.getObjectId(af, "RIFT:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tRIFT.notify("~r~Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
--                 if not br then
--                     C[af][5] = true
--                     TriggerServerEvent("RIFT:updateJackTable", af, C[af], false)
--                     local bs = tRIFT.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tRIFT.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tRIFT.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tRIFT.notify("~r~Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("RIFT:createLFBPropLog", "Inflatable Jack", GetEntityCoords(bs, true))
...
--                 tRIFT.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tRIFT.notify("~r~Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tRIFT.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tRIFT.getObjectId(C[af][3], "handleJack 4")
--                     TriggerServerEvent("RIFT:updateJackTable", af, C[af], true)
--                     if DoesEntityExist(bs) then
--                         TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                         DeleteEntity(bs)
--                     end
--                     if DoesEntityExist(bt) then
--                         TriggerServerEvent("RIFT:deleteProp", NetworkGetNetworkIdFromEntity(bt))
--                         DeleteEntity(bt)
--                     end
--                     TriggerServerEvent("RIFT:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tRIFT.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tRIFT.notify("~r~Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tRIFT.notify("~r~Error~w~: No vehicle found")
...
--     tRIFT.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--                 bz = 0.8
--             end
--             TriggerServerEvent("RIFT:lfbHandlingLifting", bm, by, bz)
--         end
...
--             TriggerServerEvent("RIFT:lfbLiftingFreeze", bm)
--             C[af][5] = false
--             C[af][4] = bz
--             TriggerServerEvent("RIFT:updateJackTable", af, C[af], false)
--             tRIFT.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
-- end
-- RegisterNetEvent("RIFT:lfbHandlingLifting",function(bm, by, bz)
...
-- end)
-- RegisterNetEvent("RIFT:lfbLiftingFreeze",function(bm)
...
--         if ad then
--             if ag then
--                 tRIFT.notify("~r~Error~w~: This vehicle already has chocks setup")
--             else
--                 local bu = GetEntityCoords(ae)
--                 ResetVehicleWheels(ae, true)
--                 tRIFT.loadModel(bB)
--                 TriggerServerEvent("RIFT:toggleChockWheels", af)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("RIFT:createLFBPropLog", "Air Chocks", GetEntityCoords(bC, true))
--                 local bh = GetEntityHeading(ae)
...
--                 D[af] = {af, bK, bL, bM, bN}
--                 TriggerServerEvent("RIFT:updateChockTable", af, D[af], false)
--                 SetModelAsNoLongerNeeded(bB)
--                 TaskGoStraightToCoord(tRIFT.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tRIFT.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tRIFT.getObjectId(D[af][2], "chock1")
--                 local bD = tRIFT.getObjectId(D[af][3], "chock2")
--                 local bE = tRIFT.getObjectId(D[af][4], "chock3")
--                 local bF = tRIFT.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                     DeleteEntity(bF)
--                 end
--                 TriggerServerEvent("RIFT:updateChockTable", af, D[af], true)
--                 TriggerServerEvent("RIFT:removeVehicleStablisers", af)
--                 tRIFT.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tRIFT.notify("~r~Error~w~: No car chocks found")
--             end
--         end
--     else
--         tRIFT.notify("~r~Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tRIFT.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tRIFT.notify("~r~Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tRIFT.getPlayerPed()
--     local t = tRIFT.getPlayerCoords()
--     TriggerServerEvent("RIFT:spawnThrowBag",t,tRIFT.getNetId(bR, "spawnRope(entity)"),tRIFT.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tRIFT.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("RIFT:spawnThrowBag",function(t, aq, bT)
--     local a4 = tRIFT.getPlayerPed()
--     local bv = tRIFT.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tRIFT.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tRIFT.getObjectId(bT, "spawnThrowBag 2")

local a = {
    ...
    [420] = {
        id = 420,
        position = vector3(-106.63346099854,6474.3657226562,31.626724243164),
        name = "Arena Teleport",
        destination = {421, 422, 423, 424, 425, 426},
    },
    [421] = {
        id = 421,
        position = vector3(-1427.6331787109,-2836.625,431.12649536133),
        name = "Arena 1",
        destination = {420},
    },
    [422] = {
        id = 422,
        position = vector3(-1505.1556396484,-2968.9521484375,431.12655639648),
        name = "Arena 2",
        destination = {420},
    },
    [423] = {
        id = 423,
        position = vector3(-1575.9970703125,-3090.7272949219,431.12649536133),
        name = "Arena 3",
        destination = {420},
    },
    [424] = {
        id = 424,
        position = vector3(-1759.0413818359,-2985.1520996094,431.12649536133),
        name = "Arena 4",
        destination = {420},
    },
    [425] = {
        id = 425,
        position = vector3(-1683.1710205078,-2856.494140625,431.12652587891),
        name = "Arena 5",
        destination = {420},
    },
    [426] = {
        id = 426,
        position = vector3(-1597.2296142578,-2708.8161621094,431.12649536133),
        name = "Arena 6",
        destination = {420},
    },
    [68] = {
...
RMenu.Add("vkint","mainmenu",RageUI.CreateMenu("Teleporter", "Main Menu", tPolar.getRageUIMenuWidth(), tPolar.getRageUIMenuHeight()))
local b = nil
local function c(d)
    if tPolar.getPlayerCombatTimer() > 0 then
        tPolar.notify("~r~You can not teleport whilst you have a combat timer.")
        return
    end
...
Citizen.CreateThread(function()
    for f, d in pairs(a) do
        tPolar.addMarker(d.position.x, d.position.y, d.position.z - 1, 1.0, 1.0, 1.0, 255, 255, 255, 170, 50, 27)
        tPolar.createArea("vkint_" .. d.id,d.position,2.0,10.0,l,m,function()end,d)
    end
end)

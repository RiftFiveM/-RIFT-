RegisterNetEvent("RIFT:announceRestart")
AddEventHandler("RIFT:announceRestart",function(a,b)
...
RegisterNetEvent("RIFT:smallAnnouncement",function(f,g,h,i)
    tRIFT.announceMpSmallMsg(f,g,h,i)
end)
function tRIFT.announceMpSmallMsg(f,g,h,i)

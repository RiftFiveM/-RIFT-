...
--     end
-- end)
-- AddEventHandler("RIFT:onClientSpawn",function(s, t)
--     if t then
...
--                 local u = tRIFT.getUserId()
--                 if tRIFT.isDev() then --and globalOnPrisonDuty then
--                     d = true
--                     setCursor(1)
--                     inGUIRIFT = true
--                 end
...
--             tRIFT.createArea("prisonControlPanel_" .. r,a.controlPanels[r].coords,1.5,5,enter_prisonControlPanel,exit_prisonControlPanel,ontick_prisonControlPanel,{})
--         end
--     end
-- end)
...
--                         if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
--                             if h[j[r].doorHash].currentState == 5 or h[j[r].doorHash].currentState == 0 then
--                                 TriggerServerEvent("RIFT:prisonSetDoorState", j[r].doorHash, 1)
--                             else
--                                 TriggerServerEvent("RIFT:prisonSetDoorState", j[r].doorHash, 5)
--                             end
--                             PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
--                             f = false
...
--                 if IsControlJustPressed(1, 329) or IsDisabledControlJustPressed(1, 329) then
--                     c = not c
--                     TriggerServerEvent("RIFT:prisonToggleLockdown", c)
--                 end
...
--     end
-- end
-- RegisterNetEvent("RIFT:prisonSyncLockdown",function(v)
--     c = v
--     if c then
--         RefreshInterior(b)
...
--     end
-- end)
-- tRIFT.createThreadOnTick(func_drawControlPanel)
-- RegisterNetEvent("RIFT:prisonUpdateGuardNumber",function(w)
--     g = w
-- end)
-- AddEventHandler("RIFT:onClientSpawn",function(s, t)
--     if t then
...
--             local z = false
--             if g > 4 then
--                 if tRIFT.isStaffedOn() or globalOnPrisonDuty and x.overrideLock or globalOnPoliceDuty and x.pdOpen or (globalNHSOnDuty or globalLFBOnDuty) and x.nhsOpen then
--                     y = " (E to toggle lock) "
--                 end
--             else
--                 if tRIFT.isStaffedOn() or globalOnPrisonDuty or globalOnPoliceDuty and x.pdOpen or (globalNHSOnDuty or globalLFBOnDuty) and x.nhsOpen then
--                     y = " (E to toggle lock) "
--                     z = true
--                 end
--             end
...
--                 tRIFT.DrawText3D(x.coords, x.doorName .. y .. " 🔓", 0.45, 4)
--             else
--                 tRIFT.DrawText3D(x.coords, x.doorName .. y .. " 🔒", 0.45, 4)
--             end
--             if IsControlJustPressed(0, 38) and (tRIFT.isStaffedOn() or globalOnPrisonDuty and (z or x.overrideLock) or globalOnPoliceDuty and x.pdOpen or (globalNHSOnDuty or globalLFBOnDuty) and x.nhsOpen) then
...
--                     TriggerServerEvent("RIFT:prisonSetDoorState", x.doorHash, 5)
--                 else
--                     TriggerServerEvent("RIFT:prisonSetDoorState", x.doorHash, 1)
--                 end
--             end
--         end
--         for k, l in pairs(a.doors) do
--             for r = 1, #l, 1 do
--                 tRIFT.createArea("openPrisonDoor_" .. l[r].doorHash,l[r].coords,1.5,5,enter_openPrisonDoor,exit_openPrisonDoor,ontick_openPrisonDoor,{doorName = l[r].name,doorHash = l[r].doorHash,coords = l[r].coords,overrideLock = l[r].overrideLocks or false,nhsOpen = l[r].nhsOpen or false,pdOpen = l[r].pdOpen or false})
--             end
--         end
--         local A = function()
--             TriggerServerEvent("RIFT:enterPrisonAreaSyncDoors")
--         end
--         tRIFT.createArea("prisonSyncDoorsOnAreaEnter",a.prisonMainCoords,250,250,A,function()end,function()end,{})
--     end
-- end)
-- RegisterNetEvent('RIFT:prisonAreaSyncDoors', function(table)
--     h = table
--     print(json.encode(h))
...
--     end
-- end)
-- RegisterNetEvent("RIFT:prisonSyncAllDoors",function(B)
--     h = B
--     for k, l in pairs(a.doors) do
--         for r = 1, #l, 1 do
...
--     end
-- end)
-- RegisterNetEvent("RIFT:prisonSetAllDoorStates",function(C)
--     if C ~= nil then
--         for k, l in pairs(h) do
--             l.currentState = C
...
--     end
-- end)
-- RegisterNetEvent("RIFT:prisonSyncDoor",function(D, C)

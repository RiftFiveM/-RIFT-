...
RegisterNetEvent('RIFT:updateWeather')
AddEventHandler('RIFT:updateWeather', function(NewWeather, newblackout)
...
RegisterNetEvent('RIFT:updateTime')
AddEventHandler('RIFT:updateTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
AddEventHandler('playerSpawned', function()
    TriggerServerEvent('RIFT:requestSync')
end)
...
RegisterNetEvent('RIFT:notify')
AddEventHandler('RIFT:notify', function(message, blink)

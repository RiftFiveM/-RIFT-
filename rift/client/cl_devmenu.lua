RMenu.Add(
    "devmenu",
    "main",
    RageUI.CreateMenu("RIFT Dev Tools", "Developer Tools", tRIFT.getRageUIMenuWidth(), tRIFT.getRageUIMenuHeight())
)
RMenu.Add(
    "devmenu",
    "animations",
...
local h = {
    ...
    {"5_Second_Timer", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    ...
    {"ATM_WINDOW", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"BACK", "DLC_EXEC_Warehouse_Upgrade_Bench_Sounds", true},
    {"BACK", "HUD_AMMO_SHOP_SOUNDSET", true},
    {"BACK", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"BACK", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"BACK", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"Back", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"BACK", "HUD_RIFTONTEND_MP_SOUNDSET", true},
    ...
    {"CANCEL", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"CANCEL", "HUD_RIFTONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"CANCEL", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"CANCEL", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"CONTINUE", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"continue", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"CONTINUE", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Deliver_Pick_Up", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"DPAD_WEAPON_SCROLL", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Dropped", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"Enemy_Deliver", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"Enemy_Pick_Up", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"ERROR", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"ERROR", "HUD_RIFTONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"ERROR", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"EXIT", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"Friend_Deliver", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    {"Friend_Pick_Up", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", false},
    {"Friend_Pick_Up", "HUD_RIFTONTEND_MP_COLLECTABLE_SOUNDS", true},
    ...
    {"HORDE_COOL_DOWN_TIMER", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"Hover_Unlock", "DLC_XM17_IAA_Deluxos_Sounds", true},
    {"HUD_RIFTEEMODE_CANCEL_MASTER", 0, true},
    ...
    {"INFO", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"LEADER_BOARD", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"LOCAL_PLYR_CASH_COUNTER_COMPLETE", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    {"LOCAL_PLYR_CASH_COUNTER_INCREASE", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    ...
    {"Mission_Pass_Notify", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    {"Mission_Pass_Notify", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    ...
    {"MP_5_SECOND_TIMER", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"MP_AWARD", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"MP_AWARD", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"MP_Flash", "WastedSounds", true},
    {"MP_IDLE_KICK", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"MP_IDLE_TIMER", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"MP_Impact", "WastedSounds", true},
    {"MP_RANK_UP", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"MP_WAVE_COMPLETE", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"Music_Game_Over", "DLC_EXEC_ARC_MAC_SOUNDS", true},
    {"Music_Win", "DLC_EXEC_ARC_MAC_SOUNDS", true},
    {"NAV", "HUD_AMMO_SHOP_SOUNDSET", true},
    {"Nav_Arrow_Ahead", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    {"Nav_Arrow_Behind", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    {"Nav_Arrow_Left", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    {"Nav_Arrow_Right", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    {"NAV_LEFT_RIGHT", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"NAV_LEFT_RIGHT", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"NAV_LEFT_RIGHT", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"NAV_UP_DOWN", "DLC_EXEC_Warehouse_Upgrade_Bench_Sounds", true},
    {"NAV_UP_DOWN", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"NAV_UP_DOWN", "HUD_RIFTONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"NAV_UP_DOWN", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"NAV_UP_DOWN", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"NO", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"OK", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"On_Call_Player_Join", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", true},
    ...
    {"PICK_UP", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"REMOTE_PLYR_CASH_COUNTER_COMPLETE", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    {"REMOTE_PLYR_CASH_COUNTER_INCREASE", "DLC_HEISTS_GENERAL_RIFTONTEND_SOUNDS", false},
    ...
    {"ROBBERY_MONEY_TOTAL", "HUD_RIFTONTEND_CUSTOM_SOUNDSET", true},
    ...
    {"SELECT", "HUD_RIFTEEMODE_SOUNDSET", true},
    {"SELECT", "HUD_RIFTONTEND_CLOTHESSHOP_SOUNDSET", true},
    {"SELECT", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"SELECT", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    {"SELECT", "HUD_RIFTONTEND_MP_SOUNDSET", false},
    {"SELECT", "HUD_RIFTONTEND_MP_SOUNDSET", true},
    ...
    {"TOGGLE_ON", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    {"TOGGLE_ON", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"WAYPOINT_SET", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", false},
    ...
    {"YES", "HUD_RIFTONTEND_DEFAULT_SOUNDSET", true},
    ...
    {"PICKUP_WEAPON_BALL", "HUD_RIFTONTEND_WEAPONS_PICKUPS_SOUNDSET", true},
...
local i = {
    ...
    "CHN1_WAVE_ZERO_RT",
    "CHN2_MISSION_FAIL",
    "CHN2_TREV_RADIO_1_RIFTTA",
    "CHN2_TREV_RADIO_2_RIFTTA",
    "CUT_PIPE_END",
    "CUT_PIPE_START",
    "debug_stop_oneshot",
    "DH1_START",
    ...
    "FAM1_FADE_RADIO",
    "FAM1_FAIL",
    "FAM1_RIFTANK_JUMPS_RT",
    "FAM1_RIFTANK_LEAPS",
    "FAM1_RIFTANKLIN_JUMPS",
    ...
    "RIFTA0_SWITCH_1",
    "RIFTA1_FIGHT_LEAVE",
    "RIFTA1_FIGHT_LEAVE_RESTART",
    "RIFTA1_FIGHT_RESTART",
    "RIFTA1_FIGHT_START",
    "RIFTA1_HUSTLER",
    "RIFTA1_MISSION_FAIL",
    "RIFTA1_MISSION_START",
    "RIFTA1_SPEED",
    "RIFTA1_SPEED_RESTART",
    "RIFTA1_STOP_TRACK",
    "RIFTA1_WATER_ARRIVE",
    "RIFTA2_ALERTED",
    "RIFTA2_ATTACK_RT",
...
local z = module("rift-weapons", "cfg/weapons")
RageUI.CreateWhile(
    1.0,
    true,
    function()
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                tRIFT.clientPrompt(
                                    "Customization [JSON]",
                                    json.encode(tRIFT.getCustomization()),
                                    function()
                                    end
                                )
                            end
                        ...
                        function(A, B, C)
                            if C then
                                tRIFT.clientPrompt(
                                    ...
                                    "",
                                    function(D)
                                        tRIFT.setCustomization(json.decode(D))
                                    end
                                )
                            end
                        end
                                ...
                                tRIFT.clientPrompt(
                                    ...
                                    function(F)
                                        tRIFT.spawnVehicle(
                                            ...
                                            E.y,
                                            E.z,
                                            GetEntityHeading(tRIFT.getPlayerPed()),
                                            true,
                                            true,
                                            true
                                        )
                        ...
                        function(A, B, C)
                            if C then
                                ...
                                tRIFT.clientPrompt(
                                    ...
                                    "",
                                    function(G)
                                        local H = tRIFT.loadModel(tonumber(G))
                                        if H then
                                            local I =
                                                GetEntityCoords(PlayerPedId()) +
                                                GetEntityForwardVector(PlayerPedId()) * 2.0
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                TriggerEvent("RIFT:toggleTrafficMenu")
                            end
                        end
                    )
                    RageUI.Button(
                    ...
                    --     function(A, B, C)
                    --         if C then
                    --             TriggerServerEvent("RIFT:jobSelector")
                    --         end
                    --     end
                    -- )
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = tRIFT.loadModel("a_f_m_beach_01")
                    ...
                    RageUI.Button(
                        ...
                        function(A, B, C)
                            if C then
                                local J = tRIFT.loadModel("s_m_m_pilot_02")
                                local K = tRIFT.getPlayerCoords()
                                CreatePed(1, J, K.x, K.y, K.z, 0.0, true, true)
                                SetModelAsNoLongerNeeded(J)
                            end
                                ...
                                if string.match(t, S[c]) then
                                    RageUI.ButtonWithStyle(
                                        ...
                                        function(A, B, C)
                                            if C then
                                                u(R)
                                                TaskPlayAnim(tRIFT.getPlayerPed(), R, S[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
                                                RemoveAnimDict(R)
                                            end
                                        end
                                    )
                    ...
                    for c = 1, #U.anims do
                        RageUI.ButtonWithStyle(
                            ...
                            function(A, B, C)
                                if C then
                                    u(U.dict)
                                    TaskPlayAnim(tRIFT.getPlayerPed(), U.dict, U.anims[c], 1.0, -1, -1, 1, 0, 0, 0, 0)
        ...
        --                             end
        --                             RequestIpl(S[2])
        --                             SetEntityCoords(tRIFT.getPlayerPed(), tRIFT.getPlayerCoords())
        --                             local K = tRIFT.getPlayerCoords()
        --                             local W = GetInteriorAtCoords(K.x, K.y, K.z)
        --                             tRIFT.notify("[RIFT] Ipl ~g~" .. S[1] .. "(" .. S[2] .. ")" .. " ~s~loaded")
        --                         end
        --                     end
        --                 )
        --             end
...
function tRIFT.gridPositionSaver(aa, L, M)
    tRIFT.notify("pick 1st coord, press Y when done")
    ...
    Wait(250)
    tRIFT.notify("pick 2nd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    local ac = GetEntityCoords(PlayerPedId())
    Wait(250)
    tRIFT.notify("pick 3rd coord, press Y when done")
    while not IsControlJustPressed(0, 246) do
        Wait(0)
    end
    ...
    for c = 0, M - 1, 1 do
        for af = 0, L - 1, 1 do
            ...
            tRIFT.loadModel("a_m_m_fatlatin_01")
            local aj = tRIFT.spawnVehicle(aa, ai.x, ai.y, ai.z, heading, false, false, false)
    ...
    function()
        while true do
            ...
            if a then
                ...
                tRIFT.DrawText(0.32, 0.00, "X:~s~ " .. roundx, 0.4)
                tRIFT.DrawText(0.38, 0.00, "Y:~s~ " .. roundy, 0.4)
                tRIFT.DrawText(0.445, 0.00, "Z:~s~ " .. roundz, 0.4)
                heading = GetEntityHeading(ak)
                roundh = tonumber(string.format("%.2f", heading))
                tRIFT.DrawText(0.50, 0.00, "H:~s~ " .. roundh, 0.4)
                local al, am, an = table.unpack(GetEntityRotation(PlayerPedId(), 1))
                tRIFT.DrawText(0.38, 0.03, "RX:~s~ " .. tonumber(string.format("%.2f", al)), 0.4)
                tRIFT.DrawText(0.44, 0.03, "RY:~s~ " .. tonumber(string.format("%.2f", am)), 0.4)
                tRIFT.DrawText(0.495, 0.03, "RZ:~s~ " .. tonumber(string.format("%.2f", an)), 0.4)
                speed = GetEntitySpeed(PlayerPedId())
                rounds = tonumber(string.format("%.2f", speed))
                tRIFT.DrawText(0.40, 0.92, "Player Speed: ~s~" .. rounds, 0.4)
                health = GetEntityHealth(PlayerPedId())
                tRIFT.DrawText(0.40, 0.95, "Player Health: ~s~" .. health, 0.4)
                camRotX = GetGameplayCamRot(2).x
                tRIFT.DrawText(0.36, 0.88, "CR X: ~s~" .. tonumber(string.format("%.2f", camRotX)), 0.4)
                camRotY = GetGameplayCamRot(2).y
                tRIFT.DrawText(0.44, 0.88, "CR Y: ~s~" .. tonumber(string.format("%.2f", camRotY)), 0.4)
                camRotZ = GetGameplayCamRot(2).z
                tRIFT.DrawText(0.51, 0.88, "CR Z: ~s~" .. tonumber(string.format("%.2f", camRotZ)), 0.4)
                ...
                if IsPedInAnyVehicle(PlayerPedId(), 1) then
                    ...
                    tRIFT.DrawText(0.015, 0.76, "Engine Health: ~s~" .. vehenground, 0.4)
                    tRIFT.DrawText(0.015, 0.73, "Body Health: ~s~" .. vehbodround, 0.4)
                    tRIFT.DrawText(
                        0.015,
                        0.70,
                        "Vehicle Fuel: ~s~" ..
...
function tRIFT.createDebugObject(Q)
    local aX = tRIFT.loadModel(Q)

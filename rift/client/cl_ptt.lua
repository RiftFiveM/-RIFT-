local a = false
function func_ptt()
    if globalOnPoliceDuty and tRIFT.canAnim() and not noclipActive and tRIFT.isInRadioChannel() then
        local b = tRIFT.getPlayerPed()
        local c = tRIFT.getPlayerId()
        if a then
            ...
            if
             ...
             then
                ...
                tRIFT.loadAnimDict("random@arrests")
...
tRIFT.createThreadOnTick(func_ptt)

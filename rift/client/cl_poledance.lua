            ...
            local function v(w)
                ...
                if not d then 
                    ...
                    if IsControlJustReleased(0,51)then 
                        tRIFT.loadAnimDict('mini@strip_club@pole_dance@pole_dance'..x)
                        ...
                        NetworkAddPedToSynchronisedScene(tRIFT.getPlayerPed(),y,'mini@strip_club@pole_dance@pole_dance'..x,'pd_dance_0'..x,1.5,-4.0,1,1,1148846080,0)
                        NetworkStartSynchronisedScene(y)
                        d=true 
                    end 
                end 
            end
            tRIFT.createArea("poledance_"..r,s.coords,2.25,6,t,u,v,{poleId=r})
        end 
    end 
end)